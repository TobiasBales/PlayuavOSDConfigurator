...
class Map extends Component {
  ...
  render() {
    ...
    const { setFontSize, setRadius, setVAlignment, setHAlignment, setVisibleOn, numberOfPanels } = this.props;
    ...
    return (
      <Parameters.ParameterList name="map">
        ...
        <Column width={50} style={{ 'paddingLeft': '5px' }}>
          <Parameters.Radius label="radius" radius={radius} radiusKey="radius" setRadius={setRadius}/>
        </Column>
