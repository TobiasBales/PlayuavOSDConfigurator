...
function getData(charCode) {
  const fontPosition = lookup[charCode];
  const row = fontPosition * dimensions.height * 2;

  const shapeStart = row;
...
const length = data.length / 2 / dimensions.height;

export default { dimensions, getData, length, offset: 32 };
